...
BASE_URL = ENV["BASE_URL"] || "http://#{APP_NAME}.cfapps.io"
...
RSpec.configure do |rspec|
  rspec.before(:suite) do
    Rake::Task["app:deploy"].invoke(ENV['RACK_ENV'], APP_NAME, APP_NAME, ENV['PRICING_SERVICE_URL']) unless MANAGE_DEPLOYED_APP
  end
